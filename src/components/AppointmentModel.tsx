      ...
      <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-2xl w-full space-y-6 relative">
        ...
        <div className="space-y-1">
          ...
          <p className="text-gray-500 text-sm text-center">
            Schedule a one-on-one meeting with our property advisors.
          </p>
        </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  {['WhatsApp', 'Zoom', 'Google Meet'].map((method) => (
                    <label
                      key={method}
                      className="flex items-center gap-2 border border-gray-300 rounded-md px-3 py-2 cursor-pointer hover:bg-gray-100"
                    >
