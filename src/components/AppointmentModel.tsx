...
const timeSlots = ['10:00am - 10:30am','11:00am - 11:30am', '11:30am - 12:00noon', '12:00noon - 12:30pm','12:30pm - 1:00pm', '2:00pm - 2:30pm', '3:00pm - 3:30pm', '4:00 - 4:30pm', '4:30pm - 5:00pm'];
...
export default function AppointmentModal({ onClose }: { onClose: () => void }) {
  ...
  <p className="text-gray-500 text-sm text-center">Schedule a one-on-one meeting with our property advisors.</p>
</div>
