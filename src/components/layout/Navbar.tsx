      ...
      {isOpen && (
        <div className="md:hidden backdrop-blur-lg shadow-md px-4 pb-4 text-[#F5E9D3] z-40"
          ...
          <ul className="space-y-2 pt-2">
            ...
            <li><Link href="/gallery" className="hover:text-red-300" onClick={() => setIsOpen(false)}>Gallery</Link></li>
            ...
            <li><Link href="/partner" className="hover:text-red-300" onClick={() => setIsOpen(false)}>Partner With Us</Link></li>
          </ul>
        </div>
      )}
