    ...
    <section className="relative bg-[#f7f5f1] py-20 px-6 md:px-16" id="about">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-bold text-[#1a1a1a] mb-6">About Us</h2>
          <p className="text-base text-gray-700 leading-relaxed mb-4">
            At <strong>VNEXORA Luxury Estate Private Limited</strong>, we redefine hospitality by empowering hotel and resort owners with bespoke operational and strategic solutions. Rooted in excellence and driven by innovation, VNEXORA partners with visionary property owners to unlock the full potential of their assets. Whether through long-term leasing, management contracts, or curated brand alliances, our approach is built on trust, transparency, and transformative growth.
          </p>
        ...
        <div className="grid grid-cols-2 gap-6 text-center z-10">
          <div>
            <h3 className="text-3xl font-bold text-[#a17e4d]">350+</h3>
            <p className="text-gray-700 mt-1">Keys</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-[#a17e4d]">15+ Years</h3>
            <p className="text-gray-700 mt-1">Industry Experience</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-[#a17e4d]">56+</h3>
            <p className="text-gray-700 mt-1">Brands</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-[#a17e4d]">15+</h3>
